    ...
    <div className='container py-12 mx-auto'>
            ...
            <div className='flex flex-col md:flex-row gap-8 items-center'>
              <div className='md:w-1/2'>
                ...
                <p className='mb-4 text-muted-foreground leading-relaxed'>
                  ...
                  customer satisfaction. Each product in our inventory is
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
              <div className='text-center p-4'>
                ...
                <p className='text-muted-foreground'>
                  We source only the finest stationery products from around the
                  world, ensuring durability and performance.
                </p>
              </div>
              <div className='text-center p-4'>
                <div className='bg-primary/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4'>
                ...
                <p className='text-muted-foreground'>
                  We are committed to offering eco-friendly options and reducing
          ...
          <CardContent>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
              ...
              <div>
                ...
                <p className='text-muted-foreground pl-11'>
                  We are dedicated to reducing waste and offering products that
      ...
      >
        ...
        <p className='text-lg text-muted-foreground max-w-2xl mx-auto mb-6'>
          Follow us on social media to stay updated on new products, promotions,
